...
public class SummaryGenerator {
    ...
    public  String dailySummary(List<Reservation> reservations) {
        List<Reservation> filteReservations = _reservationService.viewReservations(all(),LocalDate.now());
    ...
    public  String dateRangeSummary(LocalDate startDate, LocalDate endDate) {
        List<Reservation> filteredReservations = _reservationService.viewReservations(all(),startDate,endDate);
